...
build: dist/sqlite-wasm.umd.js dist/worker.umd.js dist/sqlite-slim-fts5.wasm
...
build-dist: WEBPACK_OPTS += --mode production
build-dist: build

build-debug: EMCC_OPTS += -g4 -s ASSERTIONS=2 -s SAFE_HEAP=1 -s STACK_OVERFLOW_CHECK=1
build-debug: WEBPACK_OPTS += --mode development
